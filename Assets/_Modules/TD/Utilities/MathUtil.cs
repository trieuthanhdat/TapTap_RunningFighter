...
namespace TD.Utilities
{
    public static class MathUtil
    {
        ...
        public static int GetBaseVelocity(float[] array, int standardizedMultiplier)
        {
            float min = array[0];
            float max = array[0];
            ...
            return (int)(min / max * standardizedMultiplier);
        }
        ...
        public static float[] NormalizeArray(float[] array)
        {
            ...
            {
                result[i] = (float)(array[i] - min) / range;
            }

            return result;
        }

        public static int[] ConvertToVelocity(float[] array, int standardizedMultiplier)
        {
            int[] result = new int[array.Length];
            for (int i = 0; i < array.Length; i++)
            {
                result[i] = (int)(array[i] * standardizedMultiplier);
            }
