...
{
    //NetworkBehaviour containing only one NetworkVariableString
    //which represents this object's name.
    ...
    //Wrapping FixedString so that if we want to change player name max size in the future,
    //we only do it once here
