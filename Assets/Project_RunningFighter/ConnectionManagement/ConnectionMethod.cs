...
namespace Project_RunningFighter.ConnectionManagement
{
    public abstract class ConnectionMethodBase
    {
        ...
        protected string GetPlayerId()
        {
            ...
            {
                return UnityAutenticationManager.instance.PlayerID ;
            }

            return AuthenticationService.Instance.IsSignedIn ? AuthenticationService.Instance.PlayerId : "#pID_ds"+UnityEngine.Random.Range(1, 1000000);
        }
    }
