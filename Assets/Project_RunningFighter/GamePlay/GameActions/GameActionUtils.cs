...
{
    public static class GameActionUtils
    {
        ...
        public static bool HasLineOfSight(Vector3 character1Pos, Vector3 character2Pos, out Vector3 missPos)
        {
            ...
            character1Pos += _CharacterEyelineOffset;
            character2Pos += _CharacterEyelineOffset;
        ...
        public static Vector3 GetDashDestination(Transform characterTransform, Vector3 targetSpot, bool stopAtObstructions, float distanceToUseIfVeryClose = -1, float maxDistance = -1)
        {
            ...
            if (distanceToUseIfVeryClose != -1)
            {
                ...
                if (destinationSpot == Vector3.zero || Vector3.Distance(characterTransform.position, destinationSpot) <= _VeryCloseTeleportRange)
                {
            ...
            destinationSpot = Vector3.MoveTowards(destinationSpot, characterTransform.position, _CloseDistanceOffset);
