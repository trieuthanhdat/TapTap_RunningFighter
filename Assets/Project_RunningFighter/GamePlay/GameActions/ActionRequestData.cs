...
namespace Project_RunningFighter.Gameplay.Action
{
    ...
    {
        public GameActionID ActionID; //index of the action in the list of all actions in the game - a way to recover the reference to the instance at runtime
        ...
        public static ActionRequestData Create(GameAction action) =>
            new()
            {
