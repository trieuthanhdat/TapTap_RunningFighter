...
namespace Project_RunningFighter.Gameplay.Action
{
    ...
    public class GameActionConfig
    {
        ...
        public List<GameAction> IsInterruptableBy;
        ...
        public ProjectTileInfo[] Projectiles;
        ...
        public bool CanBeInterruptedBy(GameActionID actionActionID)
        {
