...
namespace Project_RunningFighter.ConnectionManagement
{
    ...
    class ConnectionMethodRelay : ConnectionMethodBase
    {
        ...
        public ConnectionMethodRelay(LobbyServiceController lobbyServiceFacade, LocalLobby localLobby, ConnectionManager connectionManager, ProfileManager profileManager, string playerName)
           : base(connectionManager, profileManager, playerName)
        {
