...
namespace Project_RunningFighter.ConnectionManagement
{
    ...
    //This class handle Network States as a state machine
    public class ConnectionManager : MonoBehaviour
    {
        [SerializeField] int m_NbReconnectAttempts = 2;
        [SerializeField] bool m_ConnectionApprove = true;
        ...
        void Start()
        {
            ...
            NetworkManager.NetworkConfig.ConnectionApproval = m_ConnectionApprove;
        ...
        void ApprovalCheck(NetworkManager.ConnectionApprovalRequest request, NetworkManager.ConnectionApprovalResponse response)
        {
            ...
            Debug.Log("CALLING APPROVAL CHECK: curr state " + m_CurrentState);
        }
