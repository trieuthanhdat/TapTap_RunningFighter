...
namespace Project_RunningFighter.Gameplay.Action
{
    ...
    [CreateAssetMenu(menuName = "Actions/Pick Up Action")]
    public class PickUpAction : GameAction
    {
        ...
        bool TryPickUp(ServerCharacter parent)
        {
            ...
            {
                parent.serverAnimationController.NetworkAnimator.SetTrigger(k_FailedPickupTrigger);
                return false;
            }
        ...
        {
            if (serverCharacter.CharacterLifeState == NetworkLifeState.CharacterLifeState.Fainted)
            {
