...
namespace Project_RunningFighter.Gameplay.Action
{
    public partial class FXProjectileTargetedAction
    {
        ...
        public override bool OnStartClient(ClientCharacter clientCharacter)
        {
            ...
            if (m_Target && CharacterPhysicWrapper.TryGetPhysicsWrapper(m_Target.NetworkObjectId, out var physicsWrapper))
            {
        ...
        public override void AnticipateActionClient(ClientCharacter clientCharacter)
        {
            ...
            if (!GameActionUtils.HasLineOfSight(clientCharacter.transform.position, targetSpot, out Vector3 collidePos))
            {
