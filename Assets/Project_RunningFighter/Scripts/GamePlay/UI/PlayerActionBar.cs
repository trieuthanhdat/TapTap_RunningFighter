...
{
    /// Provides logic for a player Action Bar with attack, skill buttons and a button to open emotes panel
    /// This bar tracks button clicks on player action buttons for later use by ClientInputSender
    public class PlayerActionBar : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("The button that activates the player's first special move")]
        UIHUDButton m_SpecialAction1Button;

        [SerializeField]
        [Tooltip("The button that activates the player's second special move")]
        ...
        /// and routing the events into playerActionBar.
        class ActionButtonInfo
        {
            ...
            public GameAction CurAction;

            readonly PlayerActionBar m_Owner;

            public ActionButtonInfo(ActionButtonType type, UIHUDButton button, PlayerActionBar owner)
            {
                Type = type;
                Button = button;
        ...
        void UpdateActionButton(ActionButtonInfo buttonInfo, GameAction action, bool isClickable = true)
        {
