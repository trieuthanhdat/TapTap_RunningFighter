...
using ConnectStatus = Project_RunningFighter.ConnectionManagement.ConnectStatus;
...
namespace Project_RunningFighter.Gameplay.UI
{
    public class ConnectionStatusMessageUIManager : MonoBehaviour
    {
        ...
        [Inject]
        void InjectDependencies(ISubscriber<ConnectStatus> connectStatusSub, ISubscriber<ConnectionManagement.ReconnectMessage> reconnectMessageSub)
        {
        ...
        void OnReconnectMessage(ConnectionManagement.ReconnectMessage message)
        {
